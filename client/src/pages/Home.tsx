        ...
        <div className="max-w-7xl mx-auto px-6 py-20 md:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur overflow-hidden">
                ...
                <p className="mt-4 text-sm text-zinc-400 text-center" data-testid="text-hero-caption">
