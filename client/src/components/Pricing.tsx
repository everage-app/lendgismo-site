...
export default function Pricing() {
  const features = [
    ...
    "Origination, servicing, collections, and exception workflows",
    "Approval, closing-package, and funding-control foundation",
      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-300 max-w-3xl mx-auto">
            One-time license with a hands-on code handoff. Full source code,
            docs & diagrams, demo data, and expert guidance. Multi‑tenant RBAC,
            CSV onboarding, analytics, and integrations (Plaid, Stripe, Twilio,
            SendGrid). Deploy anywhere: AWS, Azure, Google Cloud, or any modern
            cloud platform.
          </p>
        </div>
          ...
          <div className="md:flex md:items-start md:justify-between md:gap-8">
            <div className="mb-6 md:mb-0">
              ...
              <div className="text-sm text-brand-300">
                $19,999 all-in perpetual source license
              </div>
              <div className="mt-2 text-xs uppercase tracking-wide text-zinc-400">
                No recurring platform license
              </div>
            </div>
        ...
        <p className="text-xs text-zinc-400 mt-4 text-center">
          Need a formal quote or SOW? We can tailor the handoff and optional
          support window to your team’s needs.
        </p>
      </div>
    </section>
  );
